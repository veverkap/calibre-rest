...
const (
	AutomergeChoiceDisabled AutomergeChoice = "disabled"
	AutomergeChoiceIgnore AutomergeChoice = "ignore"
	AutomergeChoiceOverwrite AutomergeChoice = "overwrite"
	AutomergeChoiceNewRecord AutomergeChoice = "new_record"
)
